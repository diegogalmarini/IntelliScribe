...
export const translations = {
  en: {
    ...
    verifyDesc: "To verify your number, open the Dialer and try to make a call. You'll receive: (1) An SMS with a verification code, (2) An automated call from a US number (+1) with voice instructions in English. Once verified, your calls will display your real number instead of our fallback number.",
  ...
  es: {
    ...
    verifyDesc: "Para verificar tu número, abre el Dialer e intenta hacer una llamada. Recibirás: (1) Un SMS con un código de verificación, (2) Una llamada automática desde EE.UU. (+1) con instrucciones de voz en inglés. Una vez verificado, tus llamadas mostrarán tu número real en lugar de nuestro número de respaldo.",
