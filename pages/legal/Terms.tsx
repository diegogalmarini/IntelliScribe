        ...
        <div className="min-h-screen bg-slate-50 dark:bg-background-dark py-24 px-4 transition-colors duration-200">
            ...
            >
                ...
                <div className="space-y-12 text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">1. Uso del Servicio y Legalidad de Grabación</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">2. Cuentas y Seguridad</h2>
                        <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">3. Contenido del Usuario y Propiedad</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">4. Pagos y Suscripciones</h2>
                        <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <section className="p-8 bg-amber-50 dark:bg-amber-900/20 rounded-[2rem] border border-amber-200 dark:border-amber-700/30">
                        <h2 className="text-xl font-display font-black text-amber-600 dark:text-amber-400 mb-4 uppercase tracking-wider italic">5. Descargos de Responsabilidad de IA (Disclaimer)</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">6. Política de Uso Aceptable</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">7. Limitación de Responsabilidad</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">8. Terminación</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">9. Ley Aplicable</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">10. Cambios</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-display font-black text-slate-900 dark:text-white mb-4 uppercase tracking-wider italic">11. Contacto</h2>
                        <p>
                ...
                <div className="mt-16 pt-8 border-t border-slate-100 dark:border-white/5 flex justify-between items-center">
                    ...
                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em]">Diktalo AI. Built for Trust.</p>
                </div>
            </motion.div>
        </div>
    );
