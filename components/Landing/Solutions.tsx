        ...
        <section id="solutions" className="py-24 bg-white dark:bg-[#0b0f17] transition-colors duration-300">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    <p className="text-xs font-bold tracking-[0.1em] text-slate-500 mb-3">{t('solSectionTag')}</p>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="order-2 lg:order-1 py-[5%]">
                                <h3 className="h2 text-slate-900 dark:text-white mb-8 leading-tight">
                                    {activeContent.title}
                                </h3>

                                <p className="text-lg text-slate-600 dark:text-slate-400 mb-12 leading-relaxed font-medium" style={{ lineHeight: '1.8' }}>
                                    "{activeContent.desc}"
                                </p>
