...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col border-r border-slate-200 dark:border-border-dark bg-white dark:bg-background-dark transition-colors duration-300 hidden md:flex">
      {/* Logo */}
      <div className="h-16 flex items-center px-6 border-b border-slate-200 dark:border-border-dark/50">
        <div className="flex items-center gap-2 text-primary cursor-pointer" onClick={handleDashboardClick}>
        ...
        <nav className="space-y-1">
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors group ${
                currentRoute === AppRoute.DASHBOARD && activeFolderId === 'ALL'
                ...
                <div key={folder.id} className="group relative flex items-center">
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                            activeFolderId === folder.id && currentRoute === AppRoute.DASHBOARD
                            ? 'bg-primary/10 text-primary dark:text-blue-400'
                            : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5'
                        }`}>
