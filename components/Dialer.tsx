    ...
    if (!isOpen) {
        return (
            <button
                ...
                className="fixed bottom-6 right-6 w-14 h-14 bg-brand-green hover:bg-green-400 text-slate-900 rounded-full shadow-lg flex items-center justify-center transition-all z-50 animate-bounce-message"
            >
