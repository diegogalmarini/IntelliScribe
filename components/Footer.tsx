        ...
        <footer className="bg-white dark:bg-background-dark border-t border-slate-200 dark:border-white/5 py-16 px-4 transition-colors duration-200">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                <div className="lg:col-span-2">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span className="text-xl font-display font-black text-slate-900 dark:text-white tracking-tight uppercase">
                            Diktalo
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-400 hover:text-primary transition-all">
                            <span className="material-symbols-outlined text-xl">share</span>
                        </a>
                        <a href="mailto:support@diktalo.com" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-400 hover:text-primary transition-all">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="mailto:support@diktalo.com" className="text-slate-500 hover:text-primary transition-colors text-sm font-medium">{t('footerSupport')}</a>
                    <a href="mailto:contact@diktalo.com" className="text-slate-500 hover:text-primary transition-colors text-sm font-medium">{t('footerContact')}</a>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-slate-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-black uppercase tracking-[0.1em] text-slate-400">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <span className="px-2 py-0.5 border border-slate-200 dark:border-white/10 rounded">v1.0.0-PRO</span>
                </div>
            </div>
        </footer>
    );
